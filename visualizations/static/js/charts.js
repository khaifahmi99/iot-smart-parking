...
async function draw(){
  ...
  let resFromCurrent = await request("https://smart-parking-iotprogramming.herokuapp.com/api/current");

  let resFromUsers = await request("https://smart-parking-iotprogramming.herokuapp.com/api/users");

  let resFromOverview = await request("https://smart-parking-iotprogramming.herokuapp.com/api/overview");
